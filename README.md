...
화학정보학·분자구조표현·SMILES·기술자 → **화합물 표현 2교시 + QSAR 1교시**로 압축한 강의와 QSAR·ADMET 실습 노트북 3종(① QSAR 회귀+결과분석 ② 특징필터+ChemBERTa 전이학습 ③ ADME/T 다중 엔드포인트). 상세·Colab 링크: **[`20260825/`](20260825/)**.
